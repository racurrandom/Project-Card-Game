...
namespace SOHNE.Accessibility.ColorblindnessX
{
    ...
    public class ColorblindnessX : MonoBehaviour
    {
        ...
        int maxType;
        int _currentType = 0;
        int currentType => Settings.blindType;
        ...
        public static ColorblindnessX Instance { get; private set; }
        ...
        void Start()
        {
            if (PlayerPrefs.HasKey("Accessibility.ColorblindType"))
                Settings.blindType = PlayerPrefs.GetInt("Accessibility.ColorblindType");
            else
        ...
        public void Change(int filterIndex = -1)
        {
            ...
            Settings.blindType = Mathf.Clamp(filterIndex, 0, maxType);
            StartCoroutine(ApplyFilter());
        }
